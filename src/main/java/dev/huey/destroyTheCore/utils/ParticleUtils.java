...
public class ParticleUtils {
  ...
  public static void region(
    ...
    Location
      min = LocationUtils.min(loc1, loc2),
      max = LocationUtils.max(loc1, loc2).add(1, 1, 1);
  ...
  public static void region(List<Player> players, Location loc1, Location loc2) {
  ...
  public static void ring(
    ...
    LocationUtils.ring(centerLoc, radius, count, loc -> {
      dust(players, loc, color);
    });
  }
  public static void ring(List<Player> players, Location loc, double radius, Color color) {
  ...
  public static void spiralSphere(Location center, double radius, Particle particleType) {
