...
public abstract class ProgressiveMission extends Mission implements Listener {
  ...
  @Override
  public void start() {
    bars.put(Game.Side.RED, BossBar.bossBar(
      TextUtils.$("mission.progressive.red-bar"),
      0F,
      BossBar.Color.RED,
      BossBar.Overlay.PROGRESS
    ));
    bars.put(Game.Side.GREEN, BossBar.bossBar(
    ...
    for (Player p : Bukkit.getOnlinePlayers()) {
      ...
      Game.Side firstSide = d.side.equals(Game.Side.SPECTATOR) ? Game.Side.RED : d.side;
