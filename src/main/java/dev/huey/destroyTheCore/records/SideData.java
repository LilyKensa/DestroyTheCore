...
public class SideData {
  ...
  static public class ImmuneChance {
    ...
    public ImmuneChance(Reason reason, Player origin, double chance, int ticks) {
      this.reason = reason;
      this.origin = origin;
      this.chance = chance;
      this.ticks = ticks;
  ...
  public void addExtraDamage(ExtraDamage.Reason reason, Player origin, int ticks) {
    extraDamages.add(new ExtraDamage(reason, origin, ticks));
  }

  public void addImmuneChance(ImmuneChance.Reason reason, Player origin, double chance, int ticks) {
